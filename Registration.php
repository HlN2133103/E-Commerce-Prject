...
<div class="container">
  <div class="frame" style="height: 650px;">
    <div class="nav">
      <ul class="links">
    ...
    <div ng-app ng-init="checked = false">
				        <form action="DataBaseLogin.php"  class="form-signin" method="post" name="form">
          ...
          <div class="btn-animate">
            <button type="submit" class="btn-signin">Sign in</button>
				        ...
				        <form  action="DataBaseRegister.php"  class="form-signup" method="post" name="form">
          <label for="fullname">Full name</label>
          <input class="form-styling" type="text" name="fname" placeholder=""/>
      ...
      <div class="forgot">
        <a href="CollectEmail.asp">Forgot your password?</a>
      </div>
      <div>
